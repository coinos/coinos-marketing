...
const handleSvelte = (e, svelteEvent) => {
	...
	} else if (svelteEvent === 'sveltekit:navigation-end' && window.location.pathname === '/') {
...
function slideA() {
	return /*html*/ `
  <div id="SLIDE-A">
    <div id="TEXT" class="absolute z-20" style="opacity:${coinos.slideAcomplete ? 1 : 0}; top:${
		coinos.slideAcomplete ? '0' : '-100'
	}px;">
...
function slideB() {
  ...
  <div id="SLIDE-B" class="absolute z-20  top-0
       ...
       style="opacity:${coinos.slideBcomplete ? 1 : 0}; left: ${
		coinos.slideBcomplete ? 41 : '-100'
	}px;">
    <div class="pb-24 pt-16 xs:pt-20 sm:pt-24 flex-grow z-10">
      ...
      <div class="text-2xl text-gray-200 pr-12">
        <p class="mb-4 mt-6 font-light">
          Begin accepting Bitcoin in under <span class='text-primary'>15 seconds</span>
        </p>
        ${signupBtn}
      </div>
    </div>
...
function slideC() {
  ...
  <div id="SLIDE-C" class="absolute z-20
       ...
       style="opacity:${coinos.slideCcomplete ? 1 : 0}; top: ${
		coinos.slideCcomplete ? 0 : '-500'
	}px;">
    <div class="pb-24 pt-16 xs:pt-20 sm:pt-24 flex-grow z-10 w-4/5">
      ...
      <div class="text-2xl text-gray-200">
        <p class="mb-4 mt-6 font-light">
          <span class='text-primary'>Zero</span> deposit fees. <span class='text-primary'>Zero</span> withdrawal fees. <span class='text-primary'>1%</span> on swaps between layers.
        </p>
        ${signupBtn}
      </div>
    </div>
