...
<div
  class="header bg-secondary justify-center  pt-2 relative z-50"
...
>
  <div class="max-w-1100px	mx-auto flex pl-10 pr-7">
    ...
    <div class="flex mt-5 NAVLINKS text-lg ml-6">
      ...
      <a
        class:pos
        class="hidden lg:block border-b-4 border-secondary border-opacity-0
													text-opacity-90 text-white
													hover:text-opacity-100 transition duration-100 ease-in-out"
    ...
    <div class="ml-auto flex mt-3 pt-1 my-auto">
      <a
        ...
        class="px-6 text-lg py-1 hidden lg:block
							 text-opacity-90
      ...
      <a
        ...
        class="bg-primary text-black px-3 text-lg py-1 hidden rounded-md lg:block
    ...
    <div class="my-4 lg:hidden cursor-pointer text-white" on:click={toggleMenu}>
      <svg
    ...
    <div
      class="{menuIsOpen ? 'lg:hidden' : 'invisible'}
									absolute right-3 text-white max-w-sm z-50
									bg-secondary text-right"
      style="top:4.8rem;"
    >
      <a
        class="block sm:hidden py-6 px-5 hover:bg-white hover:bg-opacity-10"
        href="/about">About</a
      >
      <a
        class="block sm:hidden py-6 px-5 hover:bg-white hover:bg-opacity-10"
        href="/community">Community</a
      >
      <a class="block py-6 px-5 hover:bg-white hover:bg-opacity-10" href="/pos"
        >Point of Sale</a
      >
      <a class="block py-6 px-5 hover:bg-white hover:bg-opacity-10" href="/pay"
        >Pay with Bitcoin</a
      >
      <a
        class="block py-6 px-6 hover:bg-white hover:bg-opacity-10"
        href="https://coinos.io/login">Login</a
      >
      <a
...
<div class="bg-black px-2 font-Poppins">
  <div
    class="max-w-1100px footer mx-auto flex flex-wrap text-white pt-12 px-10"
  >
    <div
    ...
    <div class="w-full lg:w-1/4 mb-10">
      ...
      <ul class="list-none">
        ...
        <li class="mb-2">
          <a href="https://twitter.com/coinoswallet">Twitter</a>
        </li>
